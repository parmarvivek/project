...
<head>
    ...
    <link rel="stylesheet" href="darjling6.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>FORESTS OF DOOARS (Jaldapara 1N - Lataguri 2N)</h1>
    ...
    <div class="card">
        <div class="slideshow-container fade">
            ...
            <div class="Containers">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfe8nMqS2ybYlFkVvpjuyg6AwfMM4tfHlW6w&usqp=CAU" style="width: 100%;">
            
            </div>
          
            <div class="Containers">
             
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR853B50QJJRhduPIT_HdZU-eCOOeJ5Sdp4_w&usqp=CAU" style="width: 100%;" >
              
            </div>
          
            <div class="Containers">
              
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvleFgr2UCKxg4BZiFcxtx-P4va4LRqmOC-w&usqp=CAU"style="width: 100%;" >
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Darjeeling Holiday Tour package,a tour package specially customized for  you people, which gives you an amazing experience to visit few of the best destination in Sikkim.

            Darjeeling has been blessed with remarkable natural beauty. The lush landscapes, green pastures, meadows of exotic flowers, gurgling streams and brooks, and the snow-clad mountains, effortlessly mesmerizes all the five senses of the visitors.
            
            Book Darjeeling holiday tour package with Packthebag Tours from anywhere in India and from any other countries with or without flights</p>
    </div>
    ...
    <div class="detail">
        <div class="text-1"><h1>Day 01: NJP Rly Station / IXB Airport – Jaldapara (120 kms / 4 hrs)</h1>&nbsp
        <p>On arrival at NJP Railway Station / IXB Airport & transfer to Jaldapara. On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Jaldapara.</p></div>&nbsp
        <div class="text-2"><h1>Day 02: Jaldapara Wild Life Sanctuary – Lataguri / Chalsa (80 kms / 2 hrs)</h1>&nbsp
            <p>Early morning at 06:00 hrs visit Jaldapara Wild Life Sanctuary on back of the Elephant / by Jeep (as per availability & on direct payment basis). Back to hotel for breakfast. Transfer to Lataguri / Chalsa. Overnight stay at Lataguri / Chalsa.</p></div>&nbsp
        <div class="text-3"><h1>Day 03: Gorumara National Park + Local Sightseeing </h1>&nbsp
            <p>Early morning at 06:00 hrs visit Gorumara National Park (Watch Tower visit on direct payment basis) by Jeep. Back to hotel for breakfast. After breakfast visit Samsing, Suntalekhola & Murti River side. In afternoon visit another Watch Tower by Jeep. Overnight stay at Lataguri / Chalsa.</p></div>&nbsp
        <div class="text-4"><h1>Day 04: Lataguri / Chalsa – NJP Rly Station / IXB airport (90 kms / 3 hrs)</h1>&nbsp
            <p>After breakfast Check-out from hotel and take the departure transfers to NJP Railway Station / IXB airport for your onward journey</p></div>&nbsp
