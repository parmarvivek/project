...
<head>
    ...
    <link rel="stylesheet" href="anddetail1.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>ISLAND CALLING </h1>
    <p>Port Blair
    </p> </div>&nbsp
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Andaman Coral Holiday Tour package,a tour package specially customized for  you people, which gives you an amazing experience to visit few of the best destination in Andaman.

            Andaman has been blessed with remarkable natural beauty. The lush landscapes, green pastures, meadows of exotic flowers,beaches, Coral life mesmerizes all the five senses of the visitors.
            
            Book Andaman Coral Holiday Tour package with Packthebag Tours from anywhere in India and from any other countries with or without flights</p>
    </div>
    ...
    <div class="detail">
        ...
        <div class="text-2"><h1>Day 02: Port Blair to Havelock Island </h1>&nbsp
