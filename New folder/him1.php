...
<head>
    ...
    <link rel="stylesheet" href="him1.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>SHIMLA TOUR PACKAGE</h1>
    <p>DELHI - SHIMLA - DELHI</p> </div>&nbsp
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Shimla lies in the south-western ranges of the Himalayas at an average altitude of 2,206 metres above mean sea level and extends along
            a ridge with seven spurs provides a marvelously refreshing escape from the summer heat that blankets most of India during Summer period.
            Alternatively, Shimla provides many destinations where you can enjoy the natural loveliness, culture, tradition, etc.</p>
    </div>
    ...
    <div class="detail">
        ...
        <p>On Arrival Pickup and Depart for Shimla. On the way visit Pinjore Garden. Lunch on the way. On arrival check in hotel.
            Over Night stay in Hotel</p></div>&nbsp
        <div class="text-2"><h1>Day-2</h1>&nbsp
            <p>After Breakfast Excursion to Kufri. Kufri is famous for its Himalayan National Park, Poney and Yak Ride and One can see the endless Himalayan Panorama from Kufri, after lunch sight seeing of various places in and around. Shimla mosques built in (1830), Vice regal Lodge built in (1885), Christ Church built in (1844), The Gaiety Theatre- the first beauty contest of world was supposed to start (1887), The Grindlays Bank (1912)- the world wide bank started by Robert Melville Grindlay, The Scandal Point and The famous Shopping Plaza of the North The Mall. Over Night stay in Hotel.
                Places Covered- Kufri, Adventure Resort, Jakhoo Temple, The Ridge, Christ Church, The Mall ,Green Valley View</p></div>&nbsp
        <div class="text-3"><h1>Day-3</h1>&nbsp
            <p>After breakfast check out hotel and Back to Delhi, Evening Transfer to Hotel / Airport.<p></div>&nbsp
            </div>
