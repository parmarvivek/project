...
<head>
    ...
    <link rel="stylesheet" href="darjiling9.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>LIST OF HILLS </h1>
    <p>(Darjeeling 2N - Gangtok 3N)</p> </div>&nbsp
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Darjeeling – Gangtok (100 kms / 4 hrs) </h1>&nbsp
            <p>After breakfast proceeds to picturesque drive to Gangtok (5,500 ft.). On arrival Check-in to your hotel. Rest of the day free for leisure. Overnight stay at Gangtok.<p></div>&nbsp
        <div class="text-4"><h1>Day 04: Gangtok Local Sightseeing</h1>&nbsp
