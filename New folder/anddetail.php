...
<head>
    ...
    <link rel="stylesheet" href="anddetail.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>MAGICAL PORT BLAIR </h1>
    <p>MAGICAL PORT BLAIR 
    </p> </div>&nbsp
    ...
    <div class="card">
        <div class="slideshow-container fade">
            ...
            <div class="Containers">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKd2TAd6lppxrLh8YvodVHw7TVeoH-_qL-vw&usqp=CAU" style="width: 100%;">
            
            </div>
          
            <div class="Containers">
             
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQg9JbnIqmJASv1voHUyaaEwDGxc31cr4Hzjg&usqp=CAU" style="width: 100%;" >
              
            </div>
          
            <div class="Containers">
              
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUkikPp4yiJaDJKVb9R5vife1WCHn9N_m7CQ&usqp=CAU"style="width: 100%;" >
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        ...
        <p>
            ...
            PRICE
            Starting Per Person: Price on request
            
            TYPE
            Honeymoon/ Relax/ Sport/ Luxury
            
            Andaman honeymoon package,a tour package specially customized for  you people, which gives you an amazing experience to visit few of the best destination in Andaman. Andaman honeymoon Package includes the tour journey of Port Blair and Havelock Island
            
            Discover the best time and places to visit. With breathtakingly beautiful coastline, lush forested interior, fantastic diving possibilities and a far-flung location, the Andaman Islands are a perfect place to ramble around or simply chill out on sun-toasted beaches
            
            Book Andaman Honeymoon package with Packthebag Tours from anywhere in India and from any other countries with or without flights</p>
    </div>
    ...
    <div class="detail">
        <div class="text-1"><h1>Day 01: Arrival Port Blair + Half Day Local SS (Local Sightseeing point closed on Monday & on all Govt. holidays)</h1>&nbsp
        <p>You arrive to Port Blair, our escorts in the airport pick receive you there and then after a short introduction will take you to your first booked hotel, after check-in and once you are done with you lunch & refreshment, we will take a tour to the historic cellular jail which will be followed by the light and sound show. (the history & migration to these archipelago revolves around this monumental  architecture , once you finish taking the tour just after a gap of half an hour , you will witness the light & sound show , like any other light & sound it’s a narration of the story of the jail through light & sound )  day end here back to the hotel.</p></div>&nbsp
        <div class="text-2"><h1>Day 02: Excursion North Bay (Coral Island), Ross Island & Back (Carry Changing Cloth, water & dry food</h1>&nbsp
        ...
        <div class="text-3"><h1>Day 03: Excursion Havelock Island & Back</h1>&nbsp
            <p>After breakfast at the Hotel and as per ferry timing transfer to Jetty to take the onward ferry to Havelock Island.  On arrival at Havelock Island, our representative will receive and escort you to the Radhanagar Beach, one of the most picturesque beaches on the Islands. The beach has also been ranked 07th among the beaches of Asia by the TIME magazine.  Post lunch as per the ferry timing return back to Port Blair.</p></div>&nbsp
        <div class="text-4"><h1>Day 04: Departure from Port Blair </h1>&nbsp
