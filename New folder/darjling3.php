...
<head>
    ...
    <link rel="stylesheet" href="darjling-1.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>Darjeeling pelling Holiday Package</h1>
    <p>Bagdogra - Gangtok - Pelling - Darjeeling - Bagdogra
    </p> </div>
    <div class="card">
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Darjeeling Sikkim Tour package,a tour package specially customized for  you people, which gives you an amazing experience to visit few of the best destination in Sikkim. Kashmir Tour Package includes the journey. Starting from Bagdogra – Gangtok – Pelling – Darjeeling – Bagdogra(Airport)

            Sikkim has been blessed with remarkable natural beauty. The lush landscapes, green pastures, meadows of exotic flowers, gurgling streams and brooks, and the snow-clad mountains, effortlessly mesmerizes all the five senses of the visitors.
            
            Book Darjeeling Sikkim tour package with Packthebag Tours from anywhere in India and from any other countries with or without flights</p>
    </div>
    ...
    <div class="detail">
        <div class="text-1"><h1>Day 01: NJP Rly Station / IXB Airport – Darjeeling (75 kms / 3 hrs)</h1>&nbsp
        <p>On arrival at NJP Railway Station / IXB Airport & transfer to Darjeeling (6,950 ft.). On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Darjeeling.</p></div>&nbsp
        <div class="text-2"><h1>Day 02: Darjeeling Sightseeing</h1>&nbsp
        ...
        <div class="text-3"><h1>Day 03: Darjeeling – Pelling (80 Kms / 4 hrs)</h1>&nbsp
            <p>This morning after breakfast transfer to Pelling (6,300 ft.) via Singla Check post. On arrival check-in to your hotel. Overnight stay at Pelling.</p></div>&nbsp
        <div class="text-4"><h1>Day 04: Pelling Sightseeing </h1>&nbsp
            <p>After breakfast start for full day sightseeing. 1st Half tour - Darap village, Rimbi water Falls,  Khecheopalri Lake & Khangchendzongha waterfalls. In afternoon start for 2nd Half tour - Pemayangtse Monastery, Rabdantse Ruins, New Helipad Ground. Overnight stay at Pelling.</p></div>&nbsp
        <div class="text-5"><h1>Day 05: Pelling – Gangtok (150 kms / 5 hrs) via Chardham</h1>&nbsp
            <p>After breakfast transfer to Gangtok (5,500 ft.). Enroute visit Temi Tea Garden, Samdruptse & Siddheshwar Dham (Chardham) in Namchi. On arrival Check-in to hotel & rest of the day at leisure. Overnight stay at Gangtok.</p></div>&nbsp
        <div class="text-6"><h1>Day 06: Gangtok Local Sightseeing</h1>&nbsp
            <p>Start for a Full day city tour covering Tashi view point, Ganesh Tok, Hanuman Tok, Flower show, Cottage Industry and Handicraft Centre, Institute of Tibetology, Dro-dul Chorten, Enchey Monastery & Banjakhri Falls (maximum 6 hours). Overnight stay at Gangtok.</p></div>&nbsp
        <div class="text-7"><h1>Day 07: Excursion to Tsomgo Lake & Baba Mandir</h1>&nbsp
            <p>After breakfast start for an excursion to Tsomgo Lake (12,400 ft.) & Baba Mandir (13,200 ft.) which is 55 kms one way from Gangtok city. Overnight stay at Gangtok.</p></div>&nbsp
        <div class="text-8"><h1>Day 08: Gangtok – Kalimpong (75 kms / 3 hrs) Sightseeing</h1>&nbsp
            <p>After breakfast transfer to Kalimpong (3,950 ft.). On arrival check in to your hotel. Afternoon in visit Mangal Dham, Deolo Hills, Dr. Graham’s Home, Golf Garden, Durpin Dara Hill & Pine View Nursery back to hotel. Overnight stay at Kalimpong.<p></div>&nbsp
        <div class="text-9"><h1>Day 09: Kalimpong – NJP Rly Station / IXB airport (75 kms / 3 hrs)</h1>&nbsp
            <p>After breakfast Check-out from hotel on time and take the departure transfer to NJP Railway Station / IXB Airport for your onward journey.</p></div>
        &nbsp
