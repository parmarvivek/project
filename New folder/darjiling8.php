...
<head>
    ...
    <link rel="stylesheet" href="anddetail2.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>LOST KINGDOM (Gangtok 2N - Pelling 2N)</h1>
    <p>port blair-Havelock-neil island</p> </div>&nbsp
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Gangtok – Pelling (150 kms / 5 hrs) via Chardham</h1>&nbsp
            <p>After breakfast start for Pelling (6,300 ft.). Enroute visit Temi Tea Garden, Samdruptse & Siddheshwar Dham (Chardham) in Namchi. On arrival check-in to your hotel.Overnight stay at Pelling.<p></div>&nbsp
        <div class="text-4"><h1>Day 04: Pelling Sightseeing</h1>&nbsp
            ...
            <div class="text-5"><h1>Day 05: Pelling – NJP Rly Station / IXB Airport (136 kms / 5 hrs)</h1>&nbsp
                <p>After breakfast Check-out from hotel in time and take the departure transfers to NJP Railway Station / IXB Airport for your onward journey.</p></div>&nbsp
