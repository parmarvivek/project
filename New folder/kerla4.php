...
<head>
    ...
    <link rel="stylesheet" href="kerla4.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>
        KERALA AYURVEDA & BACKWATER TOUR
        </h1>
    <p>COCHIN - CHAMUNDI HILL - KUMARAKOM - COCHIN
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Kerala is well known for its Ayurveda culture and Backwater. kerala ayurveda Backwater tour is therefore is a customized tour package for enjoying this ultimate place.

            The Kerala backwaters are a chain of brackish lagoons and lakes lying parallel to the Malabar Coast of Kerala state in southern India. The network includes five large lakes linked by canals, both manmade and natural, fed by 38 rivers, and extending virtually half the length of Kerala state. The backwaters were formed by the action of waves and shore currents creating lowbarrier islands across the mouths of the many rivers flowing down from the Western Ghats range</p>
    </div>
