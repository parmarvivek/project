...
<head>
    ...
    <link rel="stylesheet" href="anddetail3.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>HOLIDAYS IN ANDAMAN </h1>
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: In Havelock Island </h1>&nbsp
    ...
    <form method="post">
      ...
      <li class="item-a">
       ...
       <li class="item-a">
        ...
        <div class="detail-box">
        <div class="type">
            <h3>East Himalaya Hohiday Tour</h3>
            <p>Tour Package</p>
        </div>
        <a href="#" class="price">$23</a>
        </div>
