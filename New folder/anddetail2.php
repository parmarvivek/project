...
<body>
 <header>
    ...
    <div class="ss"><h1>SPLENDID ANDAMAN </h1>
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Port Blair to Havelock Island </h1>&nbsp
        ...
        <div class="text-4"><h1>Day 04: Havelock Island to Port Blair  </h1>&nbsp
