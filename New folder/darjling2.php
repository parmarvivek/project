...
<head>
    ...
    <link rel="stylesheet" href="darjling2.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>
        GEMS OF DARJEELING (Darjeeling 2N - Kalimpong 1N)
        </h1>
    <p>Darjeeling – Kalimpong
    </p> </div>
    <div class="card">
        <div class="slideshow-container fade">
            ...
            <div class="Containers">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZepCRMgpfdpq2T1mynilZsBYyXD4TP4nAQIKv6DDghGsSAEM&s" style="width: 100%;">
            
            </div>
          
            <div class="Containers">
             
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqR_eHfdqxh2qjF13Tz-2sZcLfoWnpChC-zZEsXclsf6F9U2Vh&s" style="width: 100%;" >
              
            </div>
          
            <div class="Containers">
              
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeSV4THku3uYO1dNjMRzF3SUAk1v00K5-eanYD3bgtrVws-h8&s"style="width: 100%;" >
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>This 3 night 4 day tour package Darjeeling Kalimpong Tour package gives you an amazing experience to visit few of the best destination in Sikkim. This tour includes the journey. Starting from Bagdogra – Darjeeling – Kalimpong –  Bagdogra(Airport)
            ...
            Book Darjeeling Kalimpong tour package with Packthebag Tours from anywhere in India and from any other countries with or without flights
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Darjeeling – Kalimpong (57 kms / 2 ½ hrs) Sightseeing</h1>&nbsp
            <p>After Breakfast transfer to Kalimpong (3,950 ft.). On arrival check-in to your hotel. Afternoon enjoy half day tour of Kalimpong Visiting Mangal Dham, Deolo Hill, Dr. Graham’s Home, Golf Garden, Durpin Dara Hills & Pine View Nursery. Overnight stay at Kalimpong.</p></div>&nbsp
        <div class="text-4"><h1>Day 04: Kalimpong – NJP Rly Station / IXB Airport (75 kms / 3 hrs)</h1>&nbsp
            <p>After breakfast Check-out from hotel on time and take the departure transfer to NJP Railway Station / IXB airport for your onward journey.</p></div>&nbsp
        </div>
        &nbsp
