...
<body>
 <header>
    ...
    <div class="ss"><h1>BUDDHIST HAVEN </h1>
    <p>(Gangtok 2N - Pelling 2N - Darjeeling 2N)</p> </div>&nbsp
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-2"><h1>Day 02: Excursion to Tsomgo Lake & Baba Mandir</h1>&nbsp
            <p>After breakfast start for an excursion to Tsomgo Lake (12,400 ft.) & Baba Mandir (13,200 ft.) which is 55 kms  one way from Gangtok city. Overnight stay at Gangtok.
        ...
        <div class="text-4"><h1>Day 04: Pelling Sightseeing </h1>&nbsp
            ...
            <div class="text-5"><h1>Day 05: Pelling – Darjeeling (80 kms /4 hrs)</h1>&nbsp
                <p>This morning after breakfast transfer to Darjeeling (6,950 ft.) via Singla check post. On arrival check-in to your hotel & rest of the day at leisure. Overnight stay at Darjeeling.</p></div>&nbsp
