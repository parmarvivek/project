...
<body>
 <header>
    ...
    <div class="ss"><h1>DELLO HILLS </h1>
    <p>(Darjeeling 2N - Kalimpong 1N - Gangtok 2N)</p> </div>&nbsp
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Darjeeling – Kalimpong (57 kms / 2 ½ hrs) Sightseeing</h1>&nbsp
            <p>After Breakfast transfer to Kalimpong (3,950 ft.). On arrival Check-in to your hotel. Afternoon enjoy half day tour of Kalimpong Visit Mangal Dham, Deolo Hill, Dr. Graham’s Home, Golf Garden, Durpin Dara Hills & Pine View Nursery. Overnight stay at Kalimpong.<p></div>&nbsp
        <div class="text-4"><h1>Day 04: Kalimpong – Gangtok (75 kms / 3 hrs) Local Sightseeing</h1>&nbsp
            <p>After breakfast transfer to Gangtok (5,500 ft.). On arrival check-in to your hotel. Afternoon proceed for a half day city tour visiting Flower show, Cottage Industry and Handicraft Centre, Institute of Tibetology, Dro-dul Chorten, Enchey Monastery & Banjakhri Falls (maximum 3-4 hours). Overnight stay at Gangtok.  </p></div>&nbsp
            <div class="text-5"><h1>Day 05: Excursion to Tsomgo Lake & Baba Mandir</h1>&nbsp
