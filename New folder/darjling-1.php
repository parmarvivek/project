...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Mirik Excursion (49 kms / 2 hrs one way)</h1>&nbsp
            <p>After breakfast full day excursion trip to Mirik Lake (4,902 ft.) via Indo-Nepal Border (Extra vehicle charges will be applicable for Nepal Border to Pasupati Market). Mirik is famous for its man-made Sumendu Lake, Cardamom plantations and Tea Estates. (One can do Boating on direct payment basis in lake). In evening return to the hotel. Overnight stay at Darjeeling.</p></div>&nbsp
        <div class="text-4"><h1>Day 04: Darjeeling – NJP Rly Station / IXB Airport (75 kms / 3 hrs) </h1>&nbsp
