...
<head>
    ...
    <link rel="stylesheet" href="goa2.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>Goa Honeymoon Package</h1>
    <p>GOA</p> </div>&nbsp
        ...
        <div class="slideshow-container fade">
            ...
            <div class="video-container">
                <video src="images\production ID_5022557.mp4" id="video-slider" loop autoplay muted ></video>
            </div>
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>Book Goa Honeymoon Packages and Visit the ancient Fort Aguada, click pictures with your love to keep memories of your trip to Goa alive forever.</p>
    </div>
    ...
    <div class="detail">
        ...
        <p>On arrival at Goa Airport, pickup and transfer to the hotel. Check-in at the hotel and relax for a while. You can spend this entire first day of your Goa holiday as per your convenience. At the end of the day, come back to the hotel and stay for the night.</p></div>&nbsp
        <div class="text-2"><h1>Day-2</h1>&nbsp
            <p>Post breakfast, embark on a South Goa sightseeing tour. Visit to Shri Shantadurga Temple at Kavlem and Shri Manguesh Temple at Priol. Admire the Portuguese architectural buildings belonging to the colonial era like Basilica of Bom Jesus and Se Cathedral.
                Next, on your Goa Honeymoon Package tour, explore the Dona Paula Bay and Miramar Beach. After an entertaining day of sightseeing in Goa, evening return to hotel and overnight stay.</p></div>&nbsp
        <div class="text-3"><h1>Day-3</h1>&nbsp
            <p>Today, leave for a Dolphin sightseeing tour. Spot dolphins dancing in the waves of the sea. Come back to the hotel and have breakfast. Next, on your Honeymoon Tour of Goa, head out for a sightseeing tour of North Goa. Visit Fort Aguada, Coco Beach, Calangute Annexe, Calangute Beach, Baga Beach and Anjuna Beach. Towards the end of the 2nd day of your tour, return and overnight stay at Hotel.<p></div>&nbsp
                <div class="text-4"><h1>Day-4</h1>&nbsp
                    <p>Have a sumptuous breakfast and check-out from the hotel. Proceed to Airport to board the flight back to your home .<p></div>&nbsp
