...
<head>
    ...
    <link rel="stylesheet" href="darjiling15.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>SIKKIM DELIGHTS </h1>
    <p>(Gangtok 3N - Lachung 2N - Pelling 2N - Darjeeling 2N)</p> </div>&nbsp
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="detail">
        ...
        <div class="text-3"><h1>Day 03: Gangtok – Lachung (103 kms / 6 hrs)</h1>&nbsp
            <p>After breakfast check out from hotel with limited luggage and proceed to Lachung (8,700 ft.), North Sikkim. On the way take a break for some beautiful spots which are worth seeing and visiting like Naga Waterfall, The Confluence of Lachen Chu & Lachung Chu at Chungthang and Bhim Nala Waterfall. On arrival at Lachung check into your hotel. Dinner & Overnight stay at Lachung.<p></div>&nbsp
        <div class="text-4"><h1>Day 04: Lachung – Yumthang Valley Excursion</h1>&nbsp
            <p>After breakfast proceed to Yumthang Valley which is Known as Valley of Flowers (12,000 ft. Known as Valley of Flowers). On the way back, visit Hot Spring considered to have medicinal properties. Back to resort. Overnight stay at Lachung.  </p></div>&nbsp
            <div class="text-5"><h1>Day 05: Lachung – Gangtok (103 kms / 6 hrs)</h1>&nbsp
                <p>After breakfast proceed to Gangtok (5,500 ft.). On the way if the weather is clear you may get to see Mighty Khangchendzonga from Singhik view point. On arrival at Gangtok check-in to your hotel. Rest of the evening free for your own activities. Overnight stay at Gangtok.</p></div>&nbsp
