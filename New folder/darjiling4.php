...
<head>
    ...
    <link rel="stylesheet" href="darjiling4.css">
...
<body>
 <header>
    ...
    <div class="ss"><h1>East Himalaya Holiday Tour
    </h1>
    <p>Bagdogra - Gangtok - Lachong - Pelling - Darjeeling - Bagdogra
    ...
    <div class="card">
        <div class="slideshow-container fade">
            ...
            <div class="Containers">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6ztArJos1BD9MREZmsW3uda7rKmbXfS45oRX-eBxKMqTeepDZ&s" style="width: 100%;">
            
            </div>
          
            <div class="Containers">
             
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYA1BK-5aYHbXlaPsHj4PgGF83BpOrVf8HxUThF6zDTEmXDem4&s" style="width: 100%;" >
              
            </div>
          
            <div class="Containers">
              
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWg9h_59VMfnYojk7FFb0-EubgVqVy-dIaMIavcZYxhHqLN10&s"style="width: 100%;" >
...
function SlideShow() {
  ...
  setTimeout(SlideShow, 2000); // Change image every 2 seconds
    ...
    <div class="overview">
        <h1> Overview</h1>&nbsp
        <p>East Himalaya Holiday Tour ,a tour package specially customized for  you people, which gives you an amazing experience to visit few of the best destination in East Himalaya

 

            East Himalaya has been blessed with remarkable natural beauty. The lush landscapes, green pastures, meadows of exotic flowers, gurgling streams and brooks, and the snow-clad mountains, effortlessly mesmerizes all the five senses of the visitors.
            
            Book East Himalaya Holiday Tour with Packthebag Tours from anywhere in India and from any other countries with or without flights</p>
    </div>
    ...
    <div class="detail">
        ...
        <div class="text-2"><h1>Day 02: Gangtok Local Sightseeing</h1>&nbsp
        ...
        <div class="text-3"><h1>Day 03: Excursion to Tsomgo Lake & Baba Mandir</h1>&nbsp
        ...
        <div class="text-4"><h1>Day 04: Gangtok – NJP Rly Station / IXB airport (120 kms / 5 hrs) </h1>&nbsp
